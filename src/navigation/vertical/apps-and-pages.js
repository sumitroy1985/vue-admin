    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            title: 'Welcome',
            href: 'https://Lazot Technologies.com/demo/vuexy-mail-template/mail-welcome.html',
          },
          {
            title: 'Reset Password',
            href: 'https://Lazot Technologies.com/demo/vuexy-mail-template/mail-reset-password.html',
          },
          {
            title: 'Verify Email',
            href: 'https://Lazot Technologies.com/demo/vuexy-mail-template/mail-verify-email.html',
          },
          {
            title: 'Deactivate Account',
            href: 'https://Lazot Technologies.com/demo/vuexy-mail-template/mail-deactivate-account.html',
          },
          {
            title: 'Invoice',
            href: 'https://Lazot Technologies.com/demo/vuexy-mail-template/mail-invoice.html',
          },
          {
            title: 'Promotional',
            href: 'https://Lazot Technologies.com/demo/vuexy-mail-template/mail-promotional.html',
          },
        ],
      },
      {
