    ...
    <b-card-body>
      <app-timeline>
        ...
        <app-timeline-item variant="warning">
          <div class="d-flex justify-content-between flex-sm-row flex-column mb-sm-0 mb-1">
            <h6>{{ data.step6.title }}</h6>
            <small class="timeline-item-time text-nowrap text-muted ml-1">{{ data.step6.duration }}</small>
          </div>
          <p>{{ data.step6.subtitle }}</p>
          <b-media no-body>
            <b-media-aside class="mr-50">
              <b-avatar
                :src="data.step6.avatar"
                size="38"
              />
            </b-media-aside>
            <b-media-body class="my-auto">
              <h6 class="mb-0">
                {{ data.step6.avatarName }}
              </h6>
              <p class="mb-0">
                {{ data.step6.occupation }}
              </p>
            </b-media-body>
          </b-media>
        </app-timeline-item>
        ...
        <app-timeline-item variant="info">
          <div class="d-flex justify-content-between flex-sm-row flex-column mb-sm-0 mb-1">
            <h6>{{ data.step7.title }}</h6>
            <small class="timeline-item-time text-nowrap text-muted ml-1">{{ data.step7.duration }}</small>
          </div>
          <p>{{ data.step7.subtitle }}</p>
          <b-avatar-group size="35px">
            <b-avatar
              v-for="avatar in data.step7.avatars"
              :key="avatar.userImg"
        ...
        <app-timeline-item
          ...
          :subtitle="data.step8.subtitle"
          :time="data.step8.duration"
          variant="danger"
        />
      </app-timeline>
      <!--/ timeline -->
