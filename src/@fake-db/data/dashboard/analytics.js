...
const data = {
  ...
  timeline: {
    ...
    step2: {
      ...
      subtitle: 'Project meeting with Abhijit @10:15am',
      avatar: require('@/assets/images/portrait/small/avatar-s-9.jpg'),
      avatarName: 'Abhijit Das(Client)',
    ...
    step5: {
      ...
      subtitle: 'From 11AM to 8PM in 26/11/2021',
      img: require('@/assets/images/icons/json.png'),
      fileName: 'data.json',
      duration: '12 min ago',
    },
    step6: {
      title: 'Hardware maintanence',
      subtitle: 'From 8AM to 6PM in 16/12/2021',
      img: require('@/assets/images/icons/json.png'),
      fileName: 'data.json',
      duration: '12 min ago',
    },
    step7: {
      title: 'Farmware Testing',
      subtitle: 'From 06AM to 9PM in 08/09/2021',
      img: require('@/assets/images/icons/json.png'),
      fileName: 'data.json',
      duration: '12 min ago',
    },
    step8: {
      title: 'Onboard Testing',
      subtitle: 'From 5AM to 12PM in 03/08/2021',
      img: require('@/assets/images/icons/json.png'),
      fileName: 'data.json',
      duration: '12 min ago',
    },
  ...
  appDesign: {
    ...
    planing: [
      { title: 'Total APP', subtitle: '150' },
      { title: 'Complete APP', subtitle: '60' },
      { title: 'Pending APP', subtitle: '90' },
    ],
  },
}
/* eslint-disable global-require */
